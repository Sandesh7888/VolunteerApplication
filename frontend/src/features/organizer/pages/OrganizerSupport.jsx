            ...
            <div className="flex items-center gap-3 w-full lg:w-auto">
              <div className="flex-1 lg:w-64 relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 rounded-xl border-2 border-slate-200 focus:border-purple-500 focus:outline-none font-medium text-sm"
                />
              </div>
              <select
                value={statusFilter}
                onChange={(e) => setStatusFilter(e.target.value)}
                className="px-4 py-2.5 rounded-xl border-2 border-slate-200 focus:border-purple-500 focus:outline-none font-bold bg-white text-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105 whitespace-nowrap"
              >
                <Plus size={18} />
                New Ticket
              </button>
              ...
              <form onSubmit={handleCreateTicket} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-purple-500 focus:outline-none font-medium"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-purple-500 focus:outline-none font-medium resize-none"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-purple-500 focus:outline-none font-bold"
                    >
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    type="submit"
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
                  >
                    Submit Ticket
                  </button>
                  <button
